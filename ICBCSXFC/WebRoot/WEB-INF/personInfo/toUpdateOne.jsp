    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
        	...
        	function search() {
        		...
        		document.getElementById("searchform").action = "login/getUpdateOne.do";
        	...
        	function js_onLoad(){
        		...
        		<%
        			...
        			if(alertMsg != null){
        		%>
        		$.alert({title:"修改结果",content:"<%=alertMsg%>"});
        		<%}%>
        	}
        </script>
    </head>
    	...
    	<div align="center">
      	<form action="" method="post" id="searchform" class="form-horizontal" role="form" style="width: 95%">
      		...
      		<div id="d_account" name="d_account" class="form-group"  align="center">
      			<div>
       			<input type="text" name="p_account" id="p_account" class="form-control" style="width: 80%" placeholder="投注机号或站号（密码找回或修改）"/>
